...
<div class="header-wrapper">
	<header>
		<div class="top-wrapper">
			...
			<div class="top-brand">
				<a href="https://coebiodiversity.ur.ac.rw/">
					<img src="<?php echo $CLIENT_ROOT; ?>/images/layout/CoEB logo trans.png" alt="CoEB logo" width="100%">
				</a>
				<div class="brand-name">
					<h1>Rwanda Biodiversity Specimen Portal</h1>
					<h2>Building scientific and research capacities</h2>
				</div>
			</div>
		</div>
				...
				<ul class="menu">
					...
					<li>
						<a href="<?php echo $CLIENT_ROOT; ?>/includes/about.php">
							<?php echo (isset($LANG['H_ABOUT'])?$LANG['H_ABOUT']:'About'); ?>
						</a>
					</li>
					<li>
